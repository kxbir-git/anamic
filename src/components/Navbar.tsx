  ...
  return (
    ...
    >
      ...
      <div className="hidden items-center gap-8 sm:flex">
        ...
        {["Collections", "Lookbook"].map((item) => (
          <a key={item} href="#" className="font-body text-sm font-medium uppercase tracking-[0.2em] text-foreground/60 transition-colors hover:text-neon-orange">
            {item}
          </a>
        ))}
      </div>
      ...
      <div className="flex items-center gap-6">
        <a href="#" className="hidden font-body text-sm font-medium uppercase tracking-[0.2em] text-foreground/60 transition-colors hover:text-neon-orange sm:block">
          About
        </a>
